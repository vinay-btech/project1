...
L1 = Label(top, text="Enter Number:")
L1.pack()
...
entryWidget = Entry(top,borderwidth=5,width=30, validate="key", validatecommand=(validation, '%S'),font=('Helvetica 12 bold italic'),background='azure')
entryWidget.pack()

text1 = Text(top,border=8,relief=GROOVE,yscrollcommand=True,wrap=WORD,width=52,height=8,font=('Helvetica 15 bold italic'),background='azure')
